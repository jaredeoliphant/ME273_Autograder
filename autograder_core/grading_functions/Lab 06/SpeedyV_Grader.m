function [Score, Feedback] = SpeedyV_Grader(filename)
...
% DATE: 5 March 2019
% 
% PURPOSE: SpeedyV Grading happened elsewhere! This code is only to input
...
allIDs = speedyVData.SpeedyV_IDnums
allScores = speedyVData.SpeedyV_Scores
