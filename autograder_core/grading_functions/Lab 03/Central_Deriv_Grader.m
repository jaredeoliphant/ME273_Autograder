function [Score, Feedback] = Central_Deriv_Grader(filename)

%--------------------------------------------------------------
% FILE: Central_Deriv_Grader.m
...
%--------------------------------------------------------------
    ...
    try
        ...
        Solution = [NaN   1.71828182845905      2.83296779963794      4.67077427047161      NaN]; 
        ...
        % GRADING SECTION------------------------------------------------------------
        if nnz(isnan(yprime)) == 2 && nnz(isnan(yprime) == [1 0 0 0 1]) == 5
        ...
        if norm(yprime(2:end-1) - Solution(2:end-1)) < .0001
